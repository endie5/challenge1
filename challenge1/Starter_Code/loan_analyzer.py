...
# YOUR CODE HERE!
avg_loan = total_loans/num_loans
print(avg_loan)
...
expected_return = 0.2
fair_value = future_value/(1+expected_return/12)**(remaining_months)
print(fair_value)
...
if int(loan.get("loan_price")) <= fair_value:
...
# YOUR CODE HERE!
present_value = calc_present_value(new_loan["future_value"],new_loan["remaining_months"], 0.2)
...
#working cd may be in the wrong directory, before i set path i should use os to change the cd to the pwd 
